...
INSERT INTO users(username,password,name,enabled,hardcoregamer) VALUES ('player2','player2','Paco',TRUE,TRUE);
INSERT INTO authorities(id,username,authority) VALUES (3,'player2','player');

INSERT INTO users(username,password,name,enabled,hardcoregamer) VALUES ('player3','player3','Curro',TRUE,FALSE);
